...
describe("Booking Suite 2", () => {
    ...
    it("Booking the activity 'Exp Rum 2 booking' - STEP 2.0", () => {
        ...
        cy.contains('button', 'Continuer ➔').click();
        cy.wait(1000);
        cy.get('div.relative').find('button[type="button"].w-full').contains('span', '09:35').click();
        cy.wait(1000);
    ...
    it("Booking the activity 'Exp Rum 2 booking' - STEP 2.1", () => {
        ...
        cy.contains('button', 'Continuer ➔').click();
        cy.wait(1000);
        cy.get('div.relative').find('button[type="button"].w-full').contains('span', '10:45').click();
        cy.wait(1000);
